...
export DH2_MODEL_BASE_06B=${DH2_MODEL_BASE_06B:-Qwen/Qwen3-Embedding-0.6B}
...
export DH2_TEACHER_LLM_MODEL=${DH2_TEACHER_LLM_MODEL:-glm-4.6}
export DH2_TEACHER_LLM_BASE_URL=${DH2_TEACHER_LLM_BASE_URL:-https://api.z.ai/api/paas/v4}
...
export DH2_VECTORS_BASE_06B=${DH2_VECTORS_BASE_06B:-$RDATA/embeddings_base06b/doc_vectors.npy}
export DH2_IDS_BASE_06B=${DH2_IDS_BASE_06B:-$RDATA/embeddings_base06b/doc_ids.json}
# RASC flags: cascade off in the R&D orchestrator; GroupRank off until it passes its gates
export DH_REGISTER_AWARE_CASCADE=${DH_REGISTER_AWARE_CASCADE:-0}
export DH_ENABLE_GROUPRANK=${DH_ENABLE_GROUPRANK:-0}
